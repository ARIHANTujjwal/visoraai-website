...
if (contrastButton) {
  contrastButton.addEventListener("click", () => {
    togglePreference(STORAGE_KEYS.contrast, "high-contrast", contrastButton);
  });
}

if (textButton) {
  textButton.addEventListener("click", () => {
    togglePreference(STORAGE_KEYS.text, "large-text", textButton);
  });
}

if (motionButton) {
  motionButton.addEventListener("click", () => {
    togglePreference(STORAGE_KEYS.motion, "reduce-motion", motionButton);
  });
}
